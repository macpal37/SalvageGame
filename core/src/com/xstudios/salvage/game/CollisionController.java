...
//            ((DeadBodyModel) b1.getUserData()).setActive(false);
    ...
    public void startDiverToObstacle(Fixture f1, Fixture f2, DiverModel diver, MonsterController monsterController) {
        ...
        if (b1.getUserData() instanceof DiverModel && diver.getDiverCollisionBox().equals(fd1) && b2.getUserData() instanceof Wall) {
        ...
        } else if (b2.getUserData() instanceof DiverModel && diver.getDiverCollisionBox().equals(fd2) && b1.getUserData() instanceof Wall) {
