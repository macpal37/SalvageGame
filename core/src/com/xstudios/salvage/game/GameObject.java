...
public abstract class GameObject {
    ...
    public BodyType getBodyType() {
        return (body != null ? body.getType() : getBodyType());
    }
     ...
     */
    public float getX() {
        return (body != null ? body.getPosition().x :  getX());
    }
     ...
     */
    public float getY() {
        return (body != null ? body.getPosition().y :  getY());
    }
    ...
    public float getAngle() {
        return (body != null ? body.getAngle() :  getAngle());
    }
    ...
    public Vector2 getLinearVelocity() {
        return (body != null ? body.getLinearVelocity() :  getLinearVelocity());
    }
     ...
     */
    public float getVX() {
        return (body != null ? body.getLinearVelocity().x :  getVX());
    }
     ...
     */
    public float getVY() {
        return (body != null ? body.getLinearVelocity().y :  getVY());
    }
    ...
    public float getAngularVelocity() {
        return (body != null ? body.getAngularVelocity() :  getAngularVelocity());
    }
    ...
    public boolean isActive() {
        return (body != null ? body.isActive() :  isActive());
    }
    ...
    public boolean isAwake() {
        return (body != null ? body.isAwake() :  isAwake());
    }
    ...
    public boolean isSleepingAllowed() {
        return (body != null ? body.isSleepingAllowed() :  isSleepingAllowed());
    }
    ...
    public boolean isBullet() {
        return (body != null ? body.isBullet() :  isBullet());
    }
    ...
    public boolean isFixedRotation() {
        return (body != null ? body.isFixedRotation() :  isFixedRotation());
    }
    ...
    public float getGravityScale() {
        return (body != null ? body.getGravityScale() :  getGravityScale());
    }
    ...
    public float getLinearDamping() {
        return (body != null ? body.getLinearDamping() :  getLinearDamping());
    }
    ...
    public float getAngularDamping() {
        return (body != null ? body.getAngularDamping() :  getAngularDamping());
    }
    ...
    public Vector2 getCentroid() {
        return  (body != null ? body.getLocalCenter() :  getCentroid());
    }
    ...
    public float getInertia() {
        return  (body != null ? body.getInertia() :  getInertia());
    }
    ...
    public float getMass() {
        return  (body != null ? body.getMass() :  getMass());
    }
